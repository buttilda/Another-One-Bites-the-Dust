...
public class Reference {
	...
	public static final String DEPENDENCIES = "required-after:Forge@[9.10.1.849,);required-after:TConstruct@[1.5.3,);after:IC2;after:Mekanism;after:ThermalExpansion;after:EnderIO";
